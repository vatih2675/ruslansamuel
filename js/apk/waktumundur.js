const countdownSectionOpen = document.querySelector("#countdownSectionOpen");
const sectionCountdown = document.querySelector("#sectionCountdown");
const countdownSectionClose = document.querySelector("#countdownSectionClose");

countdownSectionOpen.addEventListener("click", function () {
  sectionCountdown.classList.remove("hidden");
  sectionCountdown.classList.add("flex");
});

countdownSectionClose.addEventListener("click", function () {
  sectionCountdown.classList.remove("flex");
  sectionCountdown.classList.add("hidden");
});
...
let upcomingDate = new Date("2024-12-13 00:00:00");
