const calculatorSectionOpen = document.querySelector("#calculatorSectionOpen");
const sectionCalculator = document.querySelector("#sectionCalculator");
const calculatorSectionClose = document.querySelector(
  "#calculatorSectionClose"
);

calculatorSectionOpen.addEventListener("click", function () {
  sectionCalculator.classList.remove("hidden");
  sectionCalculator.classList.add("flex");
});

calculatorSectionClose.addEventListener("click", function () {
  sectionCalculator.classList.remove("flex");
